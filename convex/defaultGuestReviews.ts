/**
 * Initial `siteReviews` document for `reviews.seed`. Keep in sync with
 * `GUEST_REVIEWS` / `DEFAULT_FEATURED_AUTHOR_ORDER` in `src/lib/guest-reviews.ts`.
 */
export const defaultSiteReviewsRow = {
